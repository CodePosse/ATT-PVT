...
var MembershipComponent = (function () {
    ...
    MembershipComponent.prototype.openModal = function (modalContent, user) {
        ...
        if (user) {
            ...
            this.user.profile = new __WEBPACK_IMPORTED_MODULE_4__membership_model__["b" /* UserProfile */]();
            this.user.work = new __WEBPACK_IMPORTED_MODULE_4__membership_model__["c" /* UserWork */]();
            this.user.contacts = new __WEBPACK_IMPORTED_MODULE_4__membership_model__["d" /* UserContacts */]();
            this.user.social = new __WEBPACK_IMPORTED_MODULE_4__membership_model__["e" /* UserSocial */]();
            this.user.settings = new __WEBPACK_IMPORTED_MODULE_4__membership_model__["f" /* UserSettings */]();
        }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return UserWork; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return UserContacts; });
...
function createErrorResponse(req, status, message) {
    return new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */]({
        body: { 'error': "" + message },
        url: req.url,
...
var InMemoryBackendService = (function () {
    ...
    InMemoryBackendService.prototype.commands = function (reqInfo) {
        ...
        switch (command) {
            case 'resetdb':
                this.resetDb();
                resOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */]({ status: __WEBPACK_IMPORTED_MODULE_4__http_status_codes__["b" /* STATUS */].OK });
                break;
            case 'config':
                if (method === __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */].Get) {
                    resOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */]({
                    ...
                    this.setPassThruBackend();
                    resOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */]({ status: __WEBPACK_IMPORTED_MODULE_4__http_status_codes__["b" /* STATUS */].NO_CONTENT });
                }
                break;
            default:
    ...
    InMemoryBackendService.prototype.parseUrl = function (url) {
        try {
            ...
            var query = loc.search && new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* URLSearchParams */](loc.search.substr(1));
    ...
    InMemoryBackendService.prototype.post = function (_a) {
        ...
        if (existingIx > -1) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */](res);
        }
        else {
            collection.push(item);
            headers.set('Location', resourceUrl + '/' + id);
            return new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */]({ headers: headers, body: body, status: __WEBPACK_IMPORTED_MODULE_4__http_status_codes__["b" /* STATUS */].CREATED });
        }
    };
    ...
    InMemoryBackendService.prototype.setPassThruBackend = function () {
        ...
        if (this.config.passThruUnknownUrl) {
            try {
                ...
                var browserXhr = this.injector.get(__WEBPACK_IMPORTED_MODULE_1__angular_http__["l" /* BrowserXhr */]);
                var baseResponseOptions = this.injector.get(__WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* ResponseOptions */]);
                var xsrfStrategy = this.injector.get(__WEBPACK_IMPORTED_MODULE_1__angular_http__["m" /* XSRFStrategy */]);
                this.passThruBackend = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["f" /* XHRBackend */](browserXhr, baseResponseOptions, xsrfStrategy);
            }
            catch (ex) {
    ...
    */
    ...
    InMemoryWebApiModule.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"], args: [{
                    ...
                    providers: [{ provide: __WEBPACK_IMPORTED_MODULE_1__angular_http__["f" /* XHRBackend */],
                            useFactory: inMemoryBackendServiceFactory,
                            deps: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"], __WEBPACK_IMPORTED_MODULE_2__in_memory_backend_service__["b" /* InMemoryDbService */], __WEBPACK_IMPORTED_MODULE_2__in_memory_backend_service__["c" /* InMemoryBackendConfig */]] }]
                },] },
    ];
    /** @nocollapse */
