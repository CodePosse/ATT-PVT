...
var CostComponent = (function () {
    ...
    CostComponent.prototype.ngOnInit = function () {
        this.cost = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["f" /* cost */];
    };
    ...
    CostComponent.prototype.ngDoCheck = function () {
        ...
        if (this.checkAppSettingsChanges()) {
            setTimeout(function () { return _this.cost = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["f" /* cost */].slice(); });
            this.initPreviousSettings();
        }
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return countries; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return cost; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return customers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return refunds; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return disk_space; });
var countries = [
    {
        "name": "Germany",
        "value": 8940000
...
var DiskSpaceComponent = (function () {
    ...
    DiskSpaceComponent.prototype.ngOnInit = function () {
        this.data = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["a" /* disk_space */];
    };
    ...
    DiskSpaceComponent.prototype.ngDoCheck = function () {
        var _this = this;
        if (this.checkAppSettingsChanges()) {
            setTimeout(function () { return _this.data = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["a" /* disk_space */].slice(); });
            this.initPreviousSettings();
        }
    };
...
var InfoCardsComponent = (function () {
    ...
    InfoCardsComponent.prototype.ngOnInit = function () {
        this.orders = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["b" /* orders */];
        this.products = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["c" /* products */];
        this.customers = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["d" /* customers */];
        this.refunds = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["e" /* refunds */];
    ...
    InfoCardsComponent.prototype.ngDoCheck = function () {
        var _this = this;
        if (this.checkAppSettingsChanges()) {
            setTimeout(function () { return _this.orders = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["b" /* orders */].slice(); });
            setTimeout(function () { return _this.products = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["c" /* products */].slice(); });
            setTimeout(function () { return _this.customers = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["d" /* customers */].slice(); });
            setTimeout(function () { return _this.refunds = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["e" /* refunds */].slice(); });
            this.initPreviousSettings();
        }
    };
...
var VisitorsComponent = (function () {
    ...
    VisitorsComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { return _this.countries = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["g" /* countries */]; });
        this.countries = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["g" /* countries */];
    };
    ...
    VisitorsComponent.prototype.ngDoCheck = function () {
        var _this = this;
        if (this.checkAppSettingsChanges()) {
            setTimeout(function () { return _this.countries = __WEBPACK_IMPORTED_MODULE_2__dashboard_data__["g" /* countries */].slice(); });
            this.initPreviousSettings();
        }
    };
