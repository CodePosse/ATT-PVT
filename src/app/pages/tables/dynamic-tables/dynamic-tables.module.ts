...
import { projectResultsComponent } from './projectResults/projectResults.component';
...
export const routes = [
  ...
  { path: 'testCases', component: testCasesComponent, data: { breadcrumb: 'Test Cases' } },
  { path: 'projectResults', component: projectResultsComponent, data: { breadcrumb: 'Project Results' } }
];
