...
export const routes = [
  ...
  { path: 'dynamic-tables', loadChildren: () => import('app/pages/tables/dynamic-tables/dynamic-tables.module').then(m => m.DynamicTablesModule), data: { breadcrumb: 'Dynamic Tables' } }
];
