...
var SlimLoadingBarService = (function () {
    ...
    SlimLoadingBarService.prototype.startIncrease = function (onCompleted) {
        var _this = this;
        if (onCompleted === void 0) { onCompleted = null; }
        // Stop current timer
        this.stop();
        ...
        this._intervalCounterId = setInterval(function () {
            ...
            else if (_this.progress >= 25 && _this.progress < 65) {
                increment = (Math.random() * 2) / 10;
            }
            else if (_this.progress >= 65 && _this.progress < 90) {
                increment = (Math.random()) / 10;
            }
            else if (_this.progress >= 90 && _this.progress < 99) {
